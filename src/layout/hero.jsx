...
function Hero() {
  return (
    <div className="bg-deep-purple-accent-700 min-h-screen py-auto flex flex-row items-center">
            ...
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-black sm:text-4xl md:mx-auto">
                <span className="relative inline-block">
                  <svg viewBox="0 0 52 24" fill="currentColor" className="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20 text-deep-purple-accent-100 lg:w-32 lg:-ml-28 lg:-mt-10 sm:block">
                    <defs>
                  ...
                  <span className="relative tracking-widest">VIANA</span>
                </span>{" "}
                <br />
                Video Analytic
              </h2>
              <p className="text-base text-slate-300 md:text-lg">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque rem aperiam, eaque ipsa quae.</p>
            </div>
            <div>
              <a
                href="#demo"
